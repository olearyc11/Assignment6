...
public class TeslaSalesApplication {
	...
	public static void main(String[] args) {
		...
		StreamService.findTotalYearlySales(model3, "Model 3");
		StreamService.findBestandWorstMonth(model3, "Model 3");
		System.out.println("\n");
		
		StreamService.findTotalYearlySales(modelS, "Model S");
		StreamService.findBestandWorstMonth(modelS, "Model S");
		System.out.println("\n");
		
		StreamService.findTotalYearlySales(modelX, "Model X");
		StreamService.findBestandWorstMonth(modelX, "Model X");
